export function createTable(radioLanguageChecked, radioWeekChecked, inputMaxLessons, tableValue) {
    ...
    const buttonSubmit = document.getElementById('form_create');
    const buttonDel = document.getElementById('form_delete');
    const buttonSave = document.getElementById('form_save');
